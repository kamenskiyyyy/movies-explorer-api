...
const createMovie = (req, res, next) => {
  ...
  const IS_REQUEST_INCOMPLETE = REQUIRED_FIELDS.some(fieldName => req.body[fieldName] === undefined);
  if (IS_REQUEST_INCOMPLETE) throw new ValidationError('Переданы не все обязательные поля');
  Movie.create({
    country,
    director,
    duration,
